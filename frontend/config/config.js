...
assert(
  ...
  'Expecting SITE_URL environment variable to be defined',
);
assert(
  process.env.DB_USER != null,
  'Expecting DB_USER environment variable to be defined',
);
assert(
  process.env.DB_PASSWORD != null,
  'Expecting DB_PASSWORD environment variable to be defined',
);
assert(
  process.env.DB_HOST != null,
  'Expecting DB_HOST environment variable to be defined',
);
assert(
